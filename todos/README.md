...
| [09 List registered capabilities in the console](09-list-capabilities-script.md) | [x] Done | 08 | A local Node script prints registered tools, resources, and prompts in a console table |
